...
vector similarity, and context persistence for decision making and
learning.
...
from waooaw.agents.wowmemory import WowMemory
...
def test_agent_initialization(agent):
    ...
    assert agent.coe_name == "WowMemory"
    assert agent.display_name == "WowMemory"
    assert agent.tier == 4
...
def test_agent_capabilities(agent):
    ...
    expected_capabilities = {"management": ["memory_compaction", "relevance_scoring", "garbage_collection"], "retrieval": ["semantic_search", "vector_similarity", "temporal_queries", "pattern_matching"], "sharing": ["cross_agent_knowledge", "context_synchronization", "knowledge_federation"], "storage": ["context_storage", "decision_history", "learning_persistence", "knowledge_base"]}
