"""
Tests for WowNotification
Alerting and notification routing specialist that delivers critical
messages
across multiple channels. Provides intelligent routing, priority
escalation,
...
from waooaw.agents.wownotification import WowNotification
...
def test_agent_initialization(agent):
    ...
    assert agent.coe_name == "WowNotification"
    assert agent.display_name == "WowNotification"
    assert agent.tier == 5
...
def test_agent_capabilities(agent):
    ...
    expected_capabilities = {"channels": ["email_delivery", "sms_delivery", "slack_integration", "webhook_notifications", "push_notifications"], "escalation": ["priority_escalation", "on_call_rotation", "escalation_policies", "acknowledgment_tracking"], "management": ["notification_templates", "delivery_tracking", "rate_limiting", "batch_processing"], "routing": ["intelligent_routing", "priority_based", "user_preferences", "failover_handling"]}
