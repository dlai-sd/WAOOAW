...
from waooaw.agents.wowanalytics import WowAnalytics
...
def test_agent_initialization(agent):
    ...
    assert agent.coe_name == "WowAnalytics"
    assert agent.display_name == "WowAnalytics"
    assert agent.tier == 6
...
def test_agent_capabilities(agent):
    ...
    expected_capabilities = {"analytics": ["trend_analysis", "forecasting", "anomaly_detection", "correlation_analysis"], "business_intelligence": ["revenue_analytics", "user_behavior", "agent_performance", "conversion_tracking"], "metrics": ["kpi_tracking", "custom_metrics", "metric_aggregation", "time_series_analysis"], "visualization": ["real_time_dashboards", "report_generation", "data_visualization", "interactive_charts"]}
...
def test_agent_dependencies(agent):
    ...
    expected_deps = ["WowVisionPrime", "WowAgentFactory", "WowMemory", "WowSearch"]
