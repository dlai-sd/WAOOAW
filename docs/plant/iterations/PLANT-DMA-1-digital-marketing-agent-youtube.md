...
| I3-S3 | Add audit, metrics, and run-history alignment for the agent lifecycle | Plant, CP, PP, mobile | Completed | I3-S1 |
| I3-S4 | Add regression coverage and release-closeout for the first sellable agent | cross-surface | Completed | I3-S2 and I3-S3 |
