...
| E1-S3 | CP can proxy the new YouTube connection flow without owning any business logic | Planned | `feat/PLANT-YT-CONN-1-it1-e2` |
...
| E1-S3 | CP can proxy the new YouTube connection flow without owning any business logic | CP BackEnd | Planned | E1-S2 |
