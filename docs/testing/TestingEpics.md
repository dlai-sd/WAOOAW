...
| S2.1 | Add static analysis tools to all Python service test containers | ✅ Done | @copilot | 2026-02-25 | copilot/implement-test-suite-epics | ruff>=0.3.0, mypy>=1.8.0, bandit>=1.7.7, safety>=3.0.0 added to all service requirements; bandit-baseline.json created per service; scripts/static-analysis.sh added |
| S2.2 | Add Optic OpenAPI semantic diff for Plant Gateway | ✅ Done | @copilot | 2026-02-25 | copilot/implement-test-suite-epics | optic service added to docker-compose.test.yml; plant-gateway-openapi.json baseline captured; .optic/config.yml with breaking-changes ruleset |
| S3.1 | Hypothesis property tests for Plant BackEnd core invariants | ✅ Done | @copilot | 2026-02-25 | copilot/implement-test-suite-epics | hypothesis>=6.100.0 added; test_usage_ledger_invariants.py, test_trial_billing_invariants.py, test_hash_chain_invariants.py created with 100 examples each |
| S3.2 | fast-check property tests for mobile token manager | ✅ Done | @copilot | 2026-02-25 | copilot/implement-test-suite-epics | fast-check added to package.json; tokenManager.property.test.ts created covering expiry and refresh invariants |
| S4.1 | BDD specs for 7-day trial lifecycle (Plant BackEnd) | ✅ Done | @copilot | 2026-02-25 | copilot/implement-test-suite-epics | pytest-bdd>=7.0.0 added; trial_lifecycle.feature with 4 scenarios; step definitions in test_trial_lifecycle.py |
| S4.2 | BDD specs for hire wizard flow (CP BackEnd) | ✅ Done | @copilot | 2026-02-25 | copilot/implement-test-suite-epics | pytest-bdd>=7.0.0 added to CP; hire_wizard.feature with 5 scenarios; step definitions in test_hire_wizard.py |
| S5.1 | CP BackEnd consumer Pact definitions | ✅ Done | @copilot | 2026-02-25 | copilot/implement-test-suite-epics | pact-python>=2.2.0 added; consumer pact tests for POST /auth/otp/start, POST /auth/otp/verify, GET /agents, POST /hire |
| S5.2 | Mobile consumer Pact definitions | ✅ Done | @copilot | 2026-02-25 | copilot/implement-test-suite-epics | @pact-foundation/pact added to package.json; plantGateway.pact.test.ts created with 4 consumer interactions |
| S5.3 | Plant Gateway provider Pact verification | ✅ Done | @copilot | 2026-02-25 | copilot/implement-test-suite-epics | pact-python>=2.2.0 added to Gateway; provider verification test reads pact files from tests/contracts/pacts/ |
| S6.1 | Playwright setup and OTP auth E2E journey | ✅ Done | @copilot | 2026-02-25 | copilot/implement-test-suite-epics | tests/e2e/web/ setup with playwright.config.ts; auth/otp_auth.spec.ts with OTP login journey; HTML reports to tests/e2e/web/reports/ |
| S6.2 | Playwright hire wizard and payment E2E journey | ✅ Done | @copilot | 2026-02-25 | copilot/implement-test-suite-epics | tests/e2e/web/hire/hire_wizard.spec.ts covering full hire flow |
| S6.3 | Playwright PP agent creation and approval E2E journey | ✅ Done | @copilot | 2026-02-25 | copilot/implement-test-suite-epics | tests/e2e/web/admin/agent_approval.spec.ts covering agent approval flow |
| S7.1 | Maestro Docker setup and OTP auth flow | ✅ Done | @copilot | 2026-02-25 | copilot/implement-test-suite-epics | tests/e2e/mobile/auth_otp.yaml created with full OTP auth flow steps |
| S7.2 | Maestro mobile hire agent E2E flow | ✅ Done | @copilot | 2026-02-25 | copilot/implement-test-suite-epics | tests/e2e/mobile/hire_flow.yaml created with agent browse → hire → confirm flow |
| S8.1 | Locust load test for Plant Gateway | ✅ Done | @copilot | 2026-02-25 | copilot/implement-test-suite-epics | tests/performance/locustfile.py with AuthUser and BrowseUser; headless run: 50 users, 5/s ramp, 60s; HTML report to tests/performance/reports/ |
| S8.2 | Trial concurrency load test | ✅ Done | @copilot | 2026-02-25 | copilot/implement-test-suite-epics | tests/performance/trial_concurrency.py with TrialUser simulating 100 concurrent trial starts |
| S9.1 | Bandit, Safety, Semgrep scans via Docker | ✅ Done | @copilot | 2026-02-25 | copilot/implement-test-suite-epics | scripts/security-scan.sh runs bandit+safety+semgrep for all Python services; reports to tests/security/reports/ |
| S9.2 | OWASP ZAP DAST baseline scan for Plant Gateway | ✅ Done | @copilot | 2026-02-25 | copilot/implement-test-suite-epics | ZAP service already in docker-compose.test.yml; zap-rules.tsv and reports directory created |
| S10.1 | mutmut mutation tests for Plant otp_service and trial_service | ✅ Done | @copilot | 2026-02-25 | copilot/implement-test-suite-epics | mutmut>=2.4.4 added; .mutmut.cfg targeting otp_service.py and trial_service.py; reports dir created |
| S10.2 | Stryker mutation tests for mobile auth and token manager | ✅ Done | @copilot | 2026-02-25 | copilot/implement-test-suite-epics | @stryker-mutator/core and jest-runner added; stryker.config.js targets auth.service.ts and tokenManager.service.ts; HTML reports to tests/mutation/reports/mobile-stryker/ |
| S11.1 | waooaw-regression.yml — manual web backend regression workflow | ✅ Done | @copilot | 2026-02-25 | copilot/implement-test-suite-epics | .github/workflows/waooaw-regression.yml created; workflow_dispatch with scope=full/quick; 8 jobs: static→unit+api→property+bdd→integration→contract→e2e→perf(full)→security→report |
| S11.2 | mobile-regression.yml — manual mobile regression workflow | ✅ Done | @copilot | 2026-02-25 | copilot/implement-test-suite-epics | .github/workflows/mobile-regression.yml created; workflow_dispatch with scope=full/quick; jobs: static→unit+ui→accessibility→e2e(full)→mutation(full)→report |
