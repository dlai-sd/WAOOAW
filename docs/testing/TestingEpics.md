...
| S2.1 | Add ruff/mypy/bandit/safety to all Python service requirements | ✅ Done | @copilot | 2026-02-25 | copilot/implement-full-test-suite | Appended ruff/mypy/bandit/safety/hypothesis/pytest-bdd/mutmut to Plant BackEnd; created PP BackEnd requirements-test.txt; appended safety/pytest-bdd/pact-python to CP BackEnd; appended ruff/mypy/bandit/safety/pact-python to Plant Gateway |
| S2.2 | Add Optic OpenAPI diff service and plant-gateway-openapi.json | ✅ Done | @copilot | 2026-02-25 | copilot/implement-full-test-suite | optic service added to docker-compose.test.yml; tests/contracts/plant-gateway-openapi.json and tests/contracts/.optic/config.yml created |
| S3.1 | Hypothesis property tests for ledger, billing, hash chain | ✅ Done | @copilot | 2026-02-25 | copilot/implement-full-test-suite | src/Plant/BackEnd/tests/property/ created with test_usage_ledger_invariants.py, test_trial_billing_invariants.py, test_hash_chain_invariants.py |
| S3.2 | fast-check property tests for mobile tokenManager | ✅ Done | @copilot | 2026-02-25 | copilot/implement-full-test-suite | src/mobile/__tests__/tokenManager.property.test.ts created; fast-check/stryker/pact added to package.json devDependencies |
| S4.1 | BDD trial lifecycle feature and step definitions (Plant BackEnd) | ✅ Done | @copilot | 2026-02-25 | copilot/implement-full-test-suite | src/Plant/BackEnd/tests/bdd/features/trial_lifecycle.feature and test_trial_lifecycle.py created with 4 scenarios |
| S4.2 | BDD hire wizard feature and step definitions (CP BackEnd) | ✅ Done | @copilot | 2026-02-25 | copilot/implement-full-test-suite | src/CP/BackEnd/tests/bdd/features/hire_wizard.feature and test_hire_wizard.py created with 5 scenarios |
| S5.1 | CP BackEnd consumer Pact definitions for Plant Gateway | ✅ Done | @copilot | 2026-02-25 | copilot/implement-full-test-suite | src/CP/BackEnd/tests/pact/consumer/test_plant_gateway_consumer.py created with 4 interaction contracts |
| S5.2 | Mobile consumer Pact definitions for Plant Gateway | ✅ Done | @copilot | 2026-02-25 | copilot/implement-full-test-suite | src/mobile/__tests__/pact/plantGateway.pact.test.ts created with 4 interactions; writes Mobile-Plant-Gateway.json pact file |
| S5.3 | Plant Gateway provider Pact verification | ✅ Done | @copilot | 2026-02-25 | copilot/implement-full-test-suite | src/Plant/Gateway/tests/pact/provider/test_plant_gateway_provider.py created; validates pact structure and OpenAPI baseline |
| S6.1 | Playwright setup + OTP auth E2E journey | ✅ Done | @copilot | 2026-02-25 | copilot/implement-full-test-suite | tests/e2e/web/package.json, playwright.config.ts, auth/otp_auth.spec.ts created |
| S6.2 | Playwright hire wizard E2E journey | ✅ Done | @copilot | 2026-02-25 | copilot/implement-full-test-suite | tests/e2e/web/hire/hire_wizard.spec.ts created |
| S6.3 | Playwright PP agent approval E2E journey | ✅ Done | @copilot | 2026-02-25 | copilot/implement-full-test-suite | tests/e2e/web/admin/agent_approval.spec.ts created |
| S7.1 | Maestro OTP auth flow YAML | ✅ Done | @copilot | 2026-02-25 | copilot/implement-full-test-suite | tests/e2e/mobile/auth_otp.yaml created |
| S7.2 | Maestro hire agent flow YAML | ✅ Done | @copilot | 2026-02-25 | copilot/implement-full-test-suite | tests/e2e/mobile/hire_flow.yaml created |
| S8.1 | Locust load test for Plant Gateway | ✅ Done | @copilot | 2026-02-25 | copilot/implement-full-test-suite | tests/performance/locustfile.py created with AuthUser and BrowseUser behaviours |
| S8.2 | Trial concurrency load test | ✅ Done | @copilot | 2026-02-25 | copilot/implement-full-test-suite | tests/performance/trial_concurrency.py created with TrialUser (100 concurrent) |
| S9.1 | Bandit/Safety/Semgrep security scan script | ✅ Done | @copilot | 2026-02-25 | copilot/implement-full-test-suite | scripts/security-scan.sh created and chmod +x; bandit baselines in all 4 services |
| S9.2 | Security reports dir for ZAP DAST | ✅ Done | @copilot | 2026-02-25 | copilot/implement-full-test-suite | tests/security/reports/.gitkeep created; static-analysis.sh also created |
| S10.1 | mutmut config for Plant BackEnd | ✅ Done | @copilot | 2026-02-25 | copilot/implement-full-test-suite | src/Plant/BackEnd/setup.cfg created with [mutmut] section |
| S10.2 | Stryker config for Mobile | ✅ Done | @copilot | 2026-02-25 | copilot/implement-full-test-suite | src/mobile/stryker.config.json created; tests/mutation/reports/.gitkeep created |
| S11.1 | waooaw-regression.yml GitHub Actions workflow | ✅ Done | @copilot | 2026-02-25 | copilot/implement-full-test-suite | .github/workflows/waooaw-regression.yml created with 8 jobs (static, unit-api, property-bdd, integration, contract, e2e, performance, security, report) |
| S11.2 | mobile-regression.yml GitHub Actions workflow | ✅ Done | @copilot | 2026-02-25 | copilot/implement-full-test-suite | .github/workflows/mobile-regression.yml created with 6 jobs (static, unit-ui, accessibility, e2e-maestro, mutation, report) |
