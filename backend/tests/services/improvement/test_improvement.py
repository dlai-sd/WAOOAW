"""
Tests for agent improvement services
"""

import pytest
from datetime import datetime

from app.services.improvement.pattern_detection import (
    PatternType,
    InteractionPattern,
    PatternDetector,
    SuccessPattern,
...
from app.services.improvement.feedback_analysis import (
    FeedbackType,
    FeedbackEntry,
    FeedbackAnalyzer,
    FeedbackInsight,
)
from app.services.improvement.performance_analysis import (
    MetricType,
    PerformanceMetric,
    PerformanceAnalyzer,
    Bottleneck,
