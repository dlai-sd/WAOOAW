...
**Contract**
- CP Backend exposes `GET /api/cp/payments/config` returning `{ mode: "razorpay" | "coupon", coupon_code?: string, coupon_unlimited?: boolean }` (coupon fields only in `coupon` mode).
...
- ✅ 2026-02-09: BILL-1 Phase-1: Minimal invoice artifacts slice (Plant: invoice list/get/by-order + HTML download: [src/Plant/BackEnd/api/v1/invoices_simple.py](src/Plant/BackEnd/api/v1/invoices_simple.py), mounted in [src/Plant/BackEnd/api/v1/router.py](src/Plant/BackEnd/api/v1/router.py); checkout best-effort issues invoice when `customer_id` is present: [src/Plant/BackEnd/api/v1/payments_simple.py](src/Plant/BackEnd/api/v1/payments_simple.py); Gateway enforces customer scoping by rewriting/removing caller `customer_id` on invoice GET routes: [src/Plant/Gateway/main.py](src/Plant/Gateway/main.py); CP single-door invoice endpoints proxy via Gateway: [src/CP/BackEnd/api/invoices.py](src/CP/BackEnd/api/invoices.py), mounted in [src/CP/BackEnd/main.py](src/CP/BackEnd/main.py); tests (Docker-focused): Plant [src/Plant/BackEnd/tests/unit/test_invoices_simple_api.py](src/Plant/BackEnd/tests/unit/test_invoices_simple_api.py), Gateway [src/Plant/Gateway/middleware/tests/test_proxy.py](src/Plant/Gateway/middleware/tests/test_proxy.py), CP [src/CP/BackEnd/tests/test_invoices_routes.py](src/CP/BackEnd/tests/test_invoices_routes.py)).
- ✅ 2026-02-09: HIRE-2.9 Phase-1: Receipt artifacts API (Plant issues a receipt for paid orders; invoice issuance gated by `ISSUE_GST_INVOICE` env flag) (Plant: receipts list/get/by-order + HTML download: [src/Plant/BackEnd/api/v1/receipts_simple.py](src/Plant/BackEnd/api/v1/receipts_simple.py) mounted in [src/Plant/BackEnd/api/v1/router.py](src/Plant/BackEnd/api/v1/router.py); checkout now issues receipt always and invoice only when enabled: [src/Plant/BackEnd/api/v1/payments_simple.py](src/Plant/BackEnd/api/v1/payments_simple.py); Gateway enforces customer scoping for receipts by rewriting caller `customer_id`: [src/Plant/Gateway/main.py](src/Plant/Gateway/main.py); CP single-door receipt endpoints proxy via Gateway: [src/CP/BackEnd/api/receipts.py](src/CP/BackEnd/api/receipts.py), mounted in [src/CP/BackEnd/main.py](src/CP/BackEnd/main.py); tests (Docker-focused): Plant [src/Plant/BackEnd/tests/unit/test_receipts_simple_api.py](src/Plant/BackEnd/tests/unit/test_receipts_simple_api.py), Gateway [src/Plant/Gateway/middleware/tests/test_proxy.py](src/Plant/Gateway/middleware/tests/test_proxy.py), CP [src/CP/BackEnd/tests/test_receipts_routes.py](src/CP/BackEnd/tests/test_receipts_routes.py)).
- ✅ 2026-02-09: BILL-1.3 Phase-1: CP billing history UX wired into “Usage & Billing” (fetch invoices via single-door `GET /api/cp/invoices`, render list, and download HTML via `GET /api/cp/invoices/{invoice_id}/html`) (service: [src/CP/FrontEnd/src/services/invoices.service.ts](src/CP/FrontEnd/src/services/invoices.service.ts); UI: [src/CP/FrontEnd/src/pages/authenticated/UsageBilling.tsx](src/CP/FrontEnd/src/pages/authenticated/UsageBilling.tsx); test (Docker-focused): [src/CP/FrontEnd/src/__tests__/UsageBilling.test.tsx](src/CP/FrontEnd/src/__tests__/UsageBilling.test.tsx)).
- ✅ 2026-02-09: TRIAL-1.1 Phase-1: Plant trial status API (customer-scoped list + by-subscription; backed by Phase-1 in-memory hired-agent store and includes `configured` + timestamps) (Plant: [src/Plant/BackEnd/api/v1/trial_status_simple.py](src/Plant/BackEnd/api/v1/trial_status_simple.py), mounted in [src/Plant/BackEnd/api/v1/router.py](src/Plant/BackEnd/api/v1/router.py); Gateway enforces customer scoping by rewriting/removing caller `customer_id` on trial-status routes: [src/Plant/Gateway/main.py](src/Plant/Gateway/main.py); tests (Docker-focused): Plant [src/Plant/BackEnd/tests/unit/test_trial_status_simple_api.py](src/Plant/BackEnd/tests/unit/test_trial_status_simple_api.py), Gateway [src/Plant/Gateway/middleware/tests/test_proxy.py](src/Plant/Gateway/middleware/tests/test_proxy.py)).
- ✅ 2026-02-09: TRIAL-1.2 Phase-1: CP trial banner + countdown (shows “Trial will start after setup” when not configured, otherwise shows countdown when active) (service: [src/CP/FrontEnd/src/services/trialStatus.service.ts](src/CP/FrontEnd/src/services/trialStatus.service.ts); UI: [src/CP/FrontEnd/src/pages/authenticated/MyAgents.tsx](src/CP/FrontEnd/src/pages/authenticated/MyAgents.tsx); test (Docker-focused): [src/CP/FrontEnd/src/__tests__/MyAgents.test.tsx](src/CP/FrontEnd/src/__tests__/MyAgents.test.tsx)).
- ✅ 2026-02-09: BILL-1.1 Phase-1: Separate “collect GST” vs “issue GST invoice” (coupon checkout accepts optional `gstin` for collection; GST invoice issuance remains gated by `ISSUE_GST_INVOICE`) (Plant: [src/Plant/BackEnd/api/v1/payments_simple.py](src/Plant/BackEnd/api/v1/payments_simple.py); tests (Docker-focused): [src/Plant/BackEnd/tests/unit/test_payments_coupon_api.py](src/Plant/BackEnd/tests/unit/test_payments_coupon_api.py)).
- ✅ 2026-02-09: BILL-1.2 Phase-1: Invoice metadata (optional) (when `ISSUE_GST_INVOICE=true`, issued invoices carry seller/customer GSTIN and tax breakdown fields) (Plant: invoice metadata model + renderer: [src/Plant/BackEnd/api/v1/invoices_simple.py](src/Plant/BackEnd/api/v1/invoices_simple.py); wiring from checkout: [src/Plant/BackEnd/api/v1/payments_simple.py](src/Plant/BackEnd/api/v1/payments_simple.py); test (Docker-focused): [src/Plant/BackEnd/tests/unit/test_invoices_simple_api.py](src/Plant/BackEnd/tests/unit/test_invoices_simple_api.py)).
- ✅ 2026-02-09: HIRE-2.2 Phase-1: Gateway payment endpoints routing (Gateway forwards `/api/v1/payments/*` and prevents customer spoofing by forcing authenticated `customer_id` into coupon checkout bodies and subscriptions-by-customer paths) (Gateway: [src/Plant/Gateway/main.py](src/Plant/Gateway/main.py); test (Docker-focused): [src/Plant/Gateway/middleware/tests/test_proxy.py](src/Plant/Gateway/middleware/tests/test_proxy.py)).
- ✅ 2026-02-09: END-1.5 Phase-1: Gateway cancel routing + authz (Gateway forces authenticated `customer_id` on cancel-at-period-end and rejects cancel attempts without a customer context) (Gateway: [src/Plant/Gateway/main.py](src/Plant/Gateway/main.py); test (Docker-focused): [src/Plant/Gateway/middleware/tests/test_proxy.py](src/Plant/Gateway/middleware/tests/test_proxy.py)).
- ✅ 2026-02-09: END-1.6 Phase-1: CP Frontend post-cancel UX (shows “Scheduled to end on <date>” when `cancel_at_period_end=true`; undo is out-of-scope for MVP) (UI: [src/CP/FrontEnd/src/pages/authenticated/MyAgents.tsx](src/CP/FrontEnd/src/pages/authenticated/MyAgents.tsx); test (Docker-focused): [src/CP/FrontEnd/src/__tests__/MyAgents.test.tsx](src/CP/FrontEnd/src/__tests__/MyAgents.test.tsx)).
- ✅ 2026-02-09: END-1.7 Phase-1: Retention policy + enforcement (Plant enforces a simple post-end retention window for hired-agent configuration/history reads; after retention expires, `GET /api/v1/hired-agents/by-subscription/{subscription_id}` returns 410; policy controlled by `END_RETENTION_DAYS` and surfaced via `subscription_ended_at` + `retention_expires_at`) (Plant: [src/Plant/BackEnd/api/v1/hired_agents_simple.py](src/Plant/BackEnd/api/v1/hired_agents_simple.py), [src/Plant/BackEnd/api/v1/payments_simple.py](src/Plant/BackEnd/api/v1/payments_simple.py); test (Docker-focused): [src/Plant/BackEnd/tests/unit/test_end_hire_cancel_api.py](src/Plant/BackEnd/tests/unit/test_end_hire_cancel_api.py)).
- ✅ 2026-02-09: END-1.8 Phase-1: Retention messaging (CP shows retention rules during cancel confirmation and after cancel is scheduled; messaging explicitly states the 30-day post-end read-only retention window and export expectation) (UI: [src/CP/FrontEnd/src/pages/authenticated/MyAgents.tsx](src/CP/FrontEnd/src/pages/authenticated/MyAgents.tsx); test (Docker-focused): [src/CP/FrontEnd/src/__tests__/MyAgents.test.tsx](src/CP/FrontEnd/src/__tests__/MyAgents.test.tsx)).
- ✅ 2026-02-08: END-1.1 → END-1.4 Phase-1: Cancel-at-period-end flow wired end-to-end (Plant: subscription get/list/cancel + deterministic period-end processing + hired-agent deactivation: [src/Plant/BackEnd/api/v1/payments_simple.py](src/Plant/BackEnd/api/v1/payments_simple.py), [src/Plant/BackEnd/api/v1/hired_agents_simple.py](src/Plant/BackEnd/api/v1/hired_agents_simple.py), test: [src/Plant/BackEnd/tests/unit/test_end_hire_cancel_api.py](src/Plant/BackEnd/tests/unit/test_end_hire_cancel_api.py); CP backend: single-door subscription list/get/cancel with optional Plant delegation + CP-local fallback: [src/CP/BackEnd/api/subscriptions.py](src/CP/BackEnd/api/subscriptions.py), [src/CP/BackEnd/services/cp_subscriptions_simple.py](src/CP/BackEnd/services/cp_subscriptions_simple.py), test: [src/CP/BackEnd/tests/test_subscriptions_routes.py](src/CP/BackEnd/tests/test_subscriptions_routes.py); CP frontend: My Agents subscription-driven UI + End Hire confirmation: [src/CP/FrontEnd/src/pages/authenticated/MyAgents.tsx](src/CP/FrontEnd/src/pages/authenticated/MyAgents.tsx), [src/CP/FrontEnd/src/services/subscriptions.service.ts](src/CP/FrontEnd/src/services/subscriptions.service.ts), test: [src/CP/FrontEnd/src/test/MyAgents.test.tsx](src/CP/FrontEnd/src/test/MyAgents.test.tsx)).
- ✅ 2026-02-09: HIRE-1 catalog wiring Phase-1: Backend-powered catalog search + CP pricing metadata wiring (Plant: `GET /api/v1/agents?q=...` search across agent name/job role/team: [src/Plant/BackEnd/api/v1/agents.py](src/Plant/BackEnd/api/v1/agents.py), test: [src/Plant/BackEnd/tests/unit/test_agents_catalog_search_api.py](src/Plant/BackEnd/tests/unit/test_agents_catalog_search_api.py); CP frontend: discovery search now uses backend `q` and AgentDetail + BookingModal show `trial_days`, `allowed_durations`, `price`: [src/CP/FrontEnd/src/pages/AgentDiscovery.tsx](src/CP/FrontEnd/src/pages/AgentDiscovery.tsx), [src/CP/FrontEnd/src/pages/AgentDetail.tsx](src/CP/FrontEnd/src/pages/AgentDetail.tsx), [src/CP/FrontEnd/src/components/BookingModal.tsx](src/CP/FrontEnd/src/components/BookingModal.tsx), [src/CP/FrontEnd/src/services/plant.service.ts](src/CP/FrontEnd/src/services/plant.service.ts); test: [src/CP/FrontEnd/src/test/BookingModal.test.tsx](src/CP/FrontEnd/src/test/BookingModal.test.tsx)).
- ✅ 2026-02-09: TRIAL-1.3 Phase-1: Deterministic trial-end processing (auto-convert to paid at trial end) (Plant: `POST /api/v1/hired-agents/process-trial-end` transitions `active` → `ended_converted` when the subscription is still active: [src/Plant/BackEnd/api/v1/hired_agents_simple.py](src/Plant/BackEnd/api/v1/hired_agents_simple.py), test: [src/Plant/BackEnd/tests/unit/test_trial_end_processing_api.py](src/Plant/BackEnd/tests/unit/test_trial_end_processing_api.py)).
- ✅ 2026-02-08: HIRE-3.1 → HIRE-3.4 Phase-1: Minimal post-payment setup wizard + persistence + activation wiring (Plant in-memory hired-agent instance draft/finalize + trial start rule; CP backend single-door draft/finalize endpoints with optional Plant delegation; CP frontend route `/hire/setup/:subscriptionId` saving drafts and activating trial) (Plant: [src/Plant/BackEnd/api/v1/hired_agents_simple.py](src/Plant/BackEnd/api/v1/hired_agents_simple.py), [src/Plant/BackEnd/api/v1/payments_simple.py](src/Plant/BackEnd/api/v1/payments_simple.py), test: [src/Plant/BackEnd/tests/unit/test_hired_agents_api.py](src/Plant/BackEnd/tests/unit/test_hired_agents_api.py); CP backend: [src/CP/BackEnd/api/hire_wizard.py](src/CP/BackEnd/api/hire_wizard.py), [src/CP/BackEnd/main.py](src/CP/BackEnd/main.py), test: [src/CP/BackEnd/tests/test_hire_wizard_routes.py](src/CP/BackEnd/tests/test_hire_wizard_routes.py); CP frontend: [src/CP/FrontEnd/src/pages/HireSetupWizard.tsx](src/CP/FrontEnd/src/pages/HireSetupWizard.tsx), [src/CP/FrontEnd/src/services/hireWizard.service.ts](src/CP/FrontEnd/src/services/hireWizard.service.ts), [src/CP/FrontEnd/src/components/BookingModal.tsx](src/CP/FrontEnd/src/components/BookingModal.tsx), [src/CP/FrontEnd/src/pages/AgentDetail.tsx](src/CP/FrontEnd/src/pages/AgentDetail.tsx)).
- ✅ 2026-02-08: HIRE-2.7 Phase-1: idempotency added to Plant coupon checkout via `Idempotency-Key` header (replay returns same order/subscription; mismatched payload returns 409) (Plant: [src/Plant/BackEnd/api/v1/payments_simple.py](src/Plant/BackEnd/api/v1/payments_simple.py), test: [src/Plant/BackEnd/tests/unit/test_payments_coupon_api.py](src/Plant/BackEnd/tests/unit/test_payments_coupon_api.py)).
- ✅ 2026-02-08: HIRE-2.1 + HIRE-2.5 Phase-1: Plant coupon checkout now creates an order + active subscription (in-memory). CP can optionally delegate coupon checkout to Plant via `CP_PAYMENTS_USE_PLANT=true` (Plant: [src/Plant/BackEnd/api/v1/payments_simple.py](src/Plant/BackEnd/api/v1/payments_simple.py), test: [src/Plant/BackEnd/tests/unit/test_payments_coupon_api.py](src/Plant/BackEnd/tests/unit/test_payments_coupon_api.py); CP: [src/CP/BackEnd/api/payments_coupon.py](src/CP/BackEnd/api/payments_coupon.py), test: [src/CP/BackEnd/tests/test_payments_coupon_routes.py](src/CP/BackEnd/tests/test_payments_coupon_routes.py)).
- ✅ 2026-02-08: REG-1.4.1 Production OTP delivery provider integrated (SMTP email) behind env flags; production never returns OTP code (service: [src/CP/BackEnd/services/cp_otp_delivery.py](src/CP/BackEnd/services/cp_otp_delivery.py), routes: [src/CP/BackEnd/api/cp_otp.py](src/CP/BackEnd/api/cp_otp.py), tests: [src/CP/BackEnd/tests/test_cp_otp_routes.py](src/CP/BackEnd/tests/test_cp_otp_routes.py), [src/CP/BackEnd/tests/test_cp_otp_login_routes.py](src/CP/BackEnd/tests/test_cp_otp_login_routes.py)).
- ✅ 2026-02-08: DOC-1.1 Align payments config endpoint/contract across sections (external path `/api/cp/payments/config`; coupon metadata included only in coupon mode).
...
- ✅ 2026-02-08: HIRE-1.2 Agent selection + duration selection UI (customer selects agent via discovery→detail; hire duration is selected in BookingModal and passed through checkout) (CP frontend: [src/CP/FrontEnd/src/components/BookingModal.tsx](src/CP/FrontEnd/src/components/BookingModal.tsx), test: [src/CP/FrontEnd/src/test/BookingModal.test.tsx](src/CP/FrontEnd/src/test/BookingModal.test.tsx)).
- ✅ 2026-02-08: HIRE-1.3 Plant agent catalog + pricing metadata (agent list/detail includes `trial_days`, `allowed_durations`, `price` for monthly INR) (Plant: [src/Plant/BackEnd/api/v1/agents.py](src/Plant/BackEnd/api/v1/agents.py), [src/Plant/BackEnd/models/schemas.py](src/Plant/BackEnd/models/schemas.py); Phase-1 in-memory API + tests: [src/Plant/BackEnd/api/v1/agents_simple.py](src/Plant/BackEnd/api/v1/agents_simple.py), [src/Plant/BackEnd/tests/test_agents_api.py](src/Plant/BackEnd/tests/test_agents_api.py)).
- ✅ 2026-02-08: HIRE-1.4 Gateway catalog endpoint proxy (Plant Gateway proxies `/api/v1/agents*` to Plant backend; added proxy test: [src/Plant/Gateway/middleware/tests/test_proxy.py](src/Plant/Gateway/middleware/tests/test_proxy.py)).

## Pending points (not yet implemented / decisions pending)
...
| REG-1.3 | CP Backend | Registration API + validation | POST `/api/cp/auth/register` validates fields, normalizes email/phone; returns `registration_id` | DB/model layer in Plant or CP store decision |
| REG-1.4 | CP Backend | OTP issuance + verify (email/phone) | POST `/api/cp/auth/otp/start` sends OTP; POST `/api/cp/auth/otp/verify` verifies; rate limited; audit logged | Email/SMS provider integration |
...
1) Payment provider preference (Razorpay vs Stripe vs other)? **Resolved**: Razorpay in production; coupon simulation in non-prod via `PAYMENTS_MODE`.
2) OTP scope: email-only MVP acceptable, or must support SMS day-1? **Partially resolved**: API supports `email` and `phone` channels; production delivery provider selection remains pending.
3) 2FA: TOTP acceptable as primary, or must be SMS? **Resolved**: TOTP implemented as primary.
4) Do we need GST invoicing day-1 for demo, or can GST be collected but invoices simplified? **Resolved**: Full GST invoicing day-1 (India).
5) Should “undo cancel” be supported (END-1.6), or keep it out for MVP? **Resolved**: Keep out for MVP.

6) Trial end rule: auto-convert to paid (continue billing) vs require explicit confirmation to continue? **Resolved**: Auto-convert to paid.
7) Do we need proration for upgrades/downgrades mid-cycle (out of scope for MVP unless required)? **Resolved**: No proration in MVP.
