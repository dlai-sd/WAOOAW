...
def custom_openapi():
    ...
    openapi_schema = get_openapi(
        title="WAOOAW Plant API",
        version="0.1.0",
        description="API documentation for WAOOAW Plant project",
...
async def swagger_ui():
    return get_swagger_ui_html(openapi_url=api_v1_router.url_path_for("openapi"), title="Swagger UI")
