...
def upgrade() -> None:
    ...
    if not table_exists("customer_platform_credentials"):
        op.create_table(
    ...
    if not index_exists("customer_platform_credentials", "ix_customer_platform_credentials_customer_id"):
        op.create_index(
    ...
    if not index_exists("customer_platform_credentials", "ix_customer_platform_credentials_platform_key"):
        op.create_index(
    ...
    if not table_exists("oauth_connection_sessions"):
        op.create_table(
    ...
    if not index_exists("oauth_connection_sessions", "ix_oauth_connection_sessions_customer_id"):
        op.create_index(
    ...
    if not index_exists("oauth_connection_sessions", "ix_oauth_connection_sessions_platform_key"):
        op.create_index(
    ...
    if not column_exists("platform_connections", "customer_platform_credential_id"):
        op.add_column(
    ...
    if not foreign_key_exists("platform_connections", "fk_platform_connections_customer_platform_credential_id"):
    ...
    if not index_exists("platform_connections", "ix_platform_connections_customer_platform_credential_id"):
        op.create_index(
