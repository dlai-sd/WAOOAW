...
def setup_error_handlers(app: FastAPI, environment: str = "production", include_trace: bool = False):
    ...
    """
    include_trace = include_trace or (environment.lower() == "development")
    
    @app.exception_handler(HTTPException)
    async def http_exception_handler(request: Request, exc: HTTPException) -> JSONResponse:
        """Handle HTTPException and format as RFC 7807."""
        return _format_http_exception(exc, request, include_trace)
    ...
    async def general_exception_handler(request: Request, exc: Exception) -> JSONResponse:
        ...
        return _format_unexpected_error(exc, request, include_trace)
