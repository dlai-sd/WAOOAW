...
export const SignUpScreen: React.FC<SignUpScreenProps> = ({
  ...
  const validateForm = (): boolean => {
    ...
    if (
      ...
      !GSTIN_REGEX.test(formData.gstNumber.trim().toUpperCase())
    ) {
          ...
          <View style={[styles.form, { marginTop: spacing.xxl }]}>
            ...
            <View style={styles.inputGroup}>
              ...
              <View style={styles.phoneRow}>
                <TouchableOpacity
                  onPress={() =>
                    !isRegistering && setCountryPickerVisible(true)
                  }
                  style={[
                ...
                <TextInput
                  ...
                  onChangeText={(v) =>
                    handleChange("phoneNationalNumber", v.replace(/\D/g, ""))
                  }
                  placeholder={
                    formData.phoneCountry === "IN" ? "9876543210" : "555123456"
                  }
                  placeholderTextColor={colors.textSecondary + "80"}
                  style={[
                    styles.input,
                    styles.phoneInput,
                    inputStyle(!!errors.phoneNationalNumber),
                  ]}
                  editable={!isRegistering}
            ...
            <View style={styles.inputGroup}>
              ...
              <View style={styles.toggleRow}>
                <TouchableOpacity
                  ...
                  accessibilityState={{
                    selected: formData.preferredContactMethod === "email",
                  }}
                >
                  <Text
                    style={[
                ...
                <TouchableOpacity
                  ...
                  accessibilityRole="radio"
                  accessibilityState={{
                    selected: formData.preferredContactMethod === "phone",
                  }}
                >
                  <Text
                    style={[
            ...
            <View style={[styles.footer, { marginTop: spacing.xl }]}>
              ...
              <TouchableOpacity
                onPress={() => {
                  if (!isRegistering) onSignInPress?.();
                }}
                disabled={isRegistering}
