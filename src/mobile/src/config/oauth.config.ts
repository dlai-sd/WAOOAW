...
export const GOOGLE_OAUTH_CONFIG = {
   ...
   * The native @react-native-google-signin/google-signin SDK reads this from
   * google-services.json automatically. This JS env var is kept for reference
   * but is NOT passed to GoogleSignin.configure() — the native layer handles it.
...
/**
 * OAuth Redirect URIs
 * No longer used — @react-native-google-signin/google-signin is a native SDK
 * that does not use redirect URIs. Kept for potential future iOS web-fallback.
 * @deprecated
 */
