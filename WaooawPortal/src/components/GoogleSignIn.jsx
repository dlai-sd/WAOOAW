 ...
 * Uses Google Identity Services (GIS) for popup authentication
...
const GoogleSignIn = ({ onSuccess, onError, buttonText = "Sign in with Google" }) => {
  ...
  useEffect(() => {
    ...
    script.onerror = () => {
      ...
      if (onError) onError(new Error('Failed to load Google Sign-In'));
    };
  ...
  }, [isScriptLoaded, clientId, isInitialized]);
  ...
  const handleCredentialResponse = async (response) => {
    try {
      ...
      const backendResponse = await fetch(`${config.apiUrl}/auth/google/verify`, {
        method: 'POST',
        headers: {
  ...
  return (
    <div className="google-signin-container">
      ...
      {/* Fallback: Custom styled button that triggers Google prompt */}
      <button 
        className="google-signin-custom" 
